    ...
    const handleCommentSubmit = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const handleOpen = () => {
            // Your logic for handling open
            toast.success("Comment added successfully"); // You can replace the console.log with your actual logic
          };

          handleOpen(); // const response = await fetch(
